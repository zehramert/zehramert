...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)]([https://linkedin.com](https://www.linkedin.com/in/zehramert8/))
[![Email](https://img.shields.io/badge/Email-EA4335?style=flat-square&logo=gmail&logoColor=white)](mailto:zehramrt98@gmail.com)
[![Google Scholar](https://img.shields.io/badge/Google_Scholar-4285F4?style=flat-square&logo=google-scholar&logoColor=white)](https://scholar.google.com/citations?user=8LoVS5YAAAAJ&hl=tr&oi=ao)
</div>
...
**ML / NLP**
`PyTorch` `TensorFlow` `scikit-learn` · `BERT` `RAG` `NER` `Fine-tuning` `Text Classification`

**Data & Backend**
`PostgreSQL` `FastAPI` `Pandas` `NumPy`
...
### 🚨 Critical Event Detection in Disaster Management
> *Senior Design Project · 2025–ongoing*

Real-time system that ingests disaster-related tweets and routes them for emergency response. Built a multi-stage NLP pipeline covering text normalization, disaster classification, intent detection, and Named Entity Recognition (NER). Currently integrating stream processing and PostgreSQL for geospatial storage with map-based visualization.
...
📄 [Read the preprint on arXiv →](https://arxiv.org/pdf/2603.16544)

---

## 📬 Get in Touch

I'm always open to research collaborations, interesting problems, and new opportunities.

**zehramrt98@gmail.com**
